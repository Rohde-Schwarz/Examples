...
namespace RsSmw_Example
{
    class Program
    {
        static void Main()
        {
            ...
            smw.Source.Bb.Nr5G.Scheduling.Cell.Subf.User.BwPart.Alloc.ApMap.Col.Row.Imaginary.Set(
                10.0, 
                CellNullRepCap.Nr1,
            ...
            smw.Source.Bb.Nr5G.Scheduling.Cell.RepCapCellNull = CellNullRepCap.Nr1;
            smw.Source.Bb.Nr5G.Scheduling.Cell.Subf.RepCapSubframeNull = SubframeNullRepCap.Nr3;
            smw.Source.Bb.Nr5G.Scheduling.Cell.Subf.User.RepCapUserNull = UserNullRepCap.Nr0;
            smw.Source.Bb.Nr5G.Scheduling.Cell.Subf.User.BwPart.RepCapBwPartNull = BwPartNullRepCap.Nr1;
            smw.Source.Bb.Nr5G.Scheduling.Cell.Subf.User.BwPart.Alloc.RepCapAllocationNull = AllocationNullRepCap.Nr0;
            smw.Source.Bb.Nr5G.Scheduling.Cell.Subf.User.BwPart.Alloc.ApMap.Col.RepCapColumnNull = ColumnNullRepCap.Nr2;
            smw.Source.Bb.Nr5G.Scheduling.Cell.Subf.User.BwPart.Alloc.ApMap.Col.Row.RepCapRowNull = RowNullRepCap.Nr3;
            ...
            var cellNr2 = smw.Source.Bb.Nr5G.Scheduling.Cell.Clone();
