Examples for the Rohde & Schwarz SMBV100B RsSmbv remote-control instrument driver

RsSmbv NuGet package is not part of the examples. You have to restore it from https://www.nuget.org :
...
- In other Visual Studio versions, use the Packet Manager Console command: Top menu View -> Other Windows -> Packet Manager Console
	PM> Update-Package -Id RsSmbv –reinstall
