...
Author:                     Jahns_P
Version Number:             1
Date of last change:        2021/11/18
...
def meassetup():
    """Prepare measurement setup for
       1. Two segments measuring in channel 1 and trace 1
       2. Two different segments measuring in channel 2 and trace 2"""

    #
    # RF Setup first for CH1
    #
    ...
    Instrument.write_str_with_opc("SENSe1:SEGment:CLEar")                                                  # Deletes all sweep segments in the channel
    ...
    Instrument.write_str_with_opc("SENSe1:SEGMent2:SWEep:POINts 101")                                      # No of Sweep Points
    ...
    #
    # Using the complete command including "SENSe" will define the channel the changes will be associated to
    Instrument.write_str_with_opc("CALCULATE2:PARAMETER:SDEFINE 'Trc2', 'S22'")
    ...
    Instrument.write_str_with_opc("SENSe2:SEGment:CLEar")                                                   # Deletes all sweep segments in CH2
                                                                                                            # This command is very important as all the segemnts defined before for CH1
    #
    # Define Segment 1 for CH2
    #

    # Using the complete command including "SENSe" will define the channel the changes will be associated to
    Instrument.write_str_with_opc("SENSe2:SEGMent1:ADD")                                                    # Add Segment 1
    Instrument.write_str_with_opc("SENSe2:SEGMent1:FREQuency:STARt 100MHz")                                 # Start Frequency
    Instrument.write_str_with_opc("SENSe2:SEGMent1:FREQuency:STOP 500MHz")                                  # Stop Frequency
    Instrument.write_str_with_opc("SENSe2:SEGMent1:SWEep:POINts 401")                                       # No of Sweep Points
    Instrument.write_str_with_opc("SENSe2:SEGMent1:POWer:LEVel 10")                                         # Output Power Level
    Instrument.write_str_with_opc("SENSe2:SEGMent1:BWIDth 500Hz")                                           # RBW

    #
    # Define Segment 2 for CH2
    #

    # Using the complete command including "SENSe" will define the channel the changes will be associated to
    Instrument.write_str_with_opc("SENSe2:SEGMent2:ADD")                                                    # Add Segment 2
    Instrument.write_str_with_opc("SENSe2:SEGMent2:FREQuency:STARt 2000MHz")                                # Start Frequency
    Instrument.write_str_with_opc("SENSe2:SEGMent2:FREQuency:STOP 2100MHz")                                 # Stop Frequency
    Instrument.write_str_with_opc("SENSe2:SEGMent2:SWEep:POINts 501")                                       # No of Sweep Points
    Instrument.write_str_with_opc("SENSe2:SEGMent2:POWer:LEVel 0")                                          # Output Power Level
    Instrument.write_str_with_opc("SENSe2:SEGMent2:BWIDth 1000Hz")                                          # RBW


def measure():
    """ Initiate sweep and capture measurement data including some marker values"""
    Instrument.write_str_with_opc("SENSe1:SWEep:TYPE SEGMent")                                              # Segmented sweep mode for CH1
    Instrument.write_str_with_opc("SENSe2:SWEep:TYPE SEGMent")                                              # Segmented sweep mode for CH2
    Instrument.write_str_with_opc("INIT:IMMediate:ALL")                                                     # Initiate trigger to all channels
    ...
    #
    # Add markers and get the results for CH2
    #
    Instrument.write_str_with_opc("CALCulate2:MARKer1:STATe ON")                                            # Activate Marker 1
    Instrument.write_str_with_opc("CALCulate2:Marker1:FUNCtion:EXECute MINimum")                            # Assign Minimum Function to Marker 1
    resmark1 = Instrument.query_str("CALCulate2:MARKer1:FUNCtion:RESult?")                                  # Read the result X,Y
    print(f"Result for CH2 Marker 2 (maximum) is: {resmark1} dB")

    Instrument.write_str_with_opc("CALCulate2:MARKer2:STATe ON")                                            # Activate Marker 2
    Instrument.write_str_with_opc("CALCulate2:Marker2:FUNCtion:EXECute MAXimum")                            # Assign Maximum Function to Marker 2
    resmark2 = Instrument.query_str("CALCulate2:MARKer2:FUNCtion:RESult?")                                  # Read the result
    print(f"Result for CH2 Marker 2 (minimum) is: {resmark2} dB")

    Instrument.write_str_with_opc("CALCulate2:MARKer3:STATe ON")                                            # Activate Marker 3
    Instrument.write_str_with_opc("CALCulate2:Marker3:X 2 GHz")                                             # Set to a dedicated Frequency
    resmark3 = Instrument.query_float(f"CALCulate2:MARKer3:Y?")                                             # Read the Y result
    print(f"Result for CH2 Marker 3 on 2 GHz is: {resmark3:0.3f} dB")

    #
    # Get Trace Data for CH2
    #

    data = Instrument.query_bin_or_ascii_float_list("FORM REAL,32;CALCulate2:DATA? SDATa")
    print("CH2 Trace Result Data is: ", data)
